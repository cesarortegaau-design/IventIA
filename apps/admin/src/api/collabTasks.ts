...
export const collabTasksApi = {
  list: (params?: any) =>
    apiClient.get('/collab-tasks', { params }).then(r => r.data),

  get: (id: string) =>
    apiClient.get(`/collab-tasks/${id}`).then(r => r.data),

  create: (data: any) =>
    apiClient.post('/collab-tasks', data).then(r => r.data),

  update: (id: string, data: any) =>
    apiClient.put(`/collab-tasks/${id}`, data).then(r => r.data),
  ...
  listDocuments: (taskId: string) =>
    apiClient.get(`/collab-tasks/${taskId}/documents`).then(r => r.data),
  ...
  listComments: (taskId: string) =>
    apiClient.get(`/collab-tasks/${taskId}/comments`).then(r => r.data),

  addComment: (taskId: string, content: string) =>
    apiClient.post(`/collab-tasks/${taskId}/comments`, { content }).then(r => r.data),
