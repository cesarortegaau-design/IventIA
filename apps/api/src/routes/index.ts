...
// Public/mixed-auth routes MUST be registered before budgetsRoutes —
// budgetsRoutes is mounted on '/' with a global authenticate middleware that
...
router.use('/approval-flows', approvalFlowsRouter)
