/**
 * SEED: Boda García López — IventIA Planner (localStorage)
 * Evento 500 invitados, sofisticada. Fecha boda: 15-Jun-2026.
 *
 * USO: Pega este script en la consola del browser mientras el Planner está abierto.
 * EventID: 3bc99b38-d059-4d8d-9fdf-346e88811780
 */
...
const timeline = {
  ...
  activities: [
    // Pre-producción
    { id:'act-101', phaseId:'ph-1', name:'Reunión final de coordinación con novios',         responsible:'Coordinadora MR', startTime:'09:00', endTime:'10:30', status:'COMPLETED', notes:'Confirmar lista final de invitados y detalles de protocolo' },
    { id:'act-102', phaseId:'ph-1', name:'Confirmación menú y maridaje con Catering Aurora', responsible:'Chef Aurora',       startTime:'11:00', endTime:'12:30', status:'COMPLETED', notes:'Menú: cena 5 tiempos, barra libre premium, cóctel con pasapalos gourmet' },
    { id:'act-103', phaseId:'ph-1', name:'Prueba de sonido e iluminación con DJ',            responsible:'DJ Neon',           startTime:'14:00', endTime:'16:00', status:'COMPLETED', notes:'Playlist aprobada por novios. Sistema L-Acoustics confirmado.' },
    ...
    { id:'act-106', phaseId:'ph-1', name:'Confirmación transporte de invitados foráneos',    responsible:'Logística JC',      startTime:'13:00', endTime:'14:00', status:'PENDING',   notes:'3 autobuses de Ciudad de México, 1 desde aeropuerto' },
    ...
    { id:'act-204', phaseId:'ph-2', name:'Montaje de 62 mesas redondas (500 pax) y chiavaris', responsible:'Mobiliario Plus', startTime:'09:00', endTime:'15:00', status:'PENDING',   notes:'Chiavaris dorados, manteles en satin ivory, menaje Christofle' },
    ...
    { id:'act-206', phaseId:'ph-2', name:'Instalación pantalla LED 9x5m + mapping',          responsible:'AV Express',        startTime:'12:00', endTime:'16:00', status:'PENDING' },
    ...
    // Cóctel
    { id:'act-401', phaseId:'ph-4', name:'Servicio de cóctel — pasapalos gourmet',           responsible:'Catering Aurora',   startTime:'19:15', endTime:'20:30', status:'PENDING',   notes:'12 tipos de pasapalos, servicio en bandeja, 80 meseros en rotación' },
    { id:'act-402', phaseId:'ph-4', name:'Barra de bebidas: espumosos y cócteles de autor',  responsible:'Bar Elite',         startTime:'19:15', endTime:'20:30', status:'PENDING' },
    { id:'act-403', phaseId:'ph-4', name:'Música ambient — cuarteto de jazz',                 responsible:'Cuarteto Allegro',  startTime:'19:15', endTime:'20:30', status:'PENDING' },
    ...
    { id:'act-405', phaseId:'ph-4', name:'Booth de fotos y experiencias',                    responsible:'Foto Booth GT',     startTime:'19:30', endTime:'23:00', status:'PENDING' },
    ...
    { id:'act-504', phaseId:'ph-5', name:'Discursos: padrinos y familia',                   responsible:'MC Ricardo',        startTime:'21:20', endTime:'21:40', status:'PENDING',   notes:'Máx 4 discursos de 3 min. c/u. MC coordina turno.' },
    ...
    { id:'act-506', phaseId:'ph-5', name:'Segundo tiempo: sopa / consomé',                  responsible:'Catering Aurora',   startTime:'21:50', endTime:'22:10', status:'PENDING' },
    { id:'act-507', phaseId:'ph-5', name:'Plato fuerte: res angus / salmón (alternado)',    responsible:'Catering Aurora',   startTime:'22:10', endTime:'22:50', status:'PENDING',   notes:'Opción vegetariana: risotto de hongos silvestres' },
    { id:'act-508', phaseId:'ph-5', name:'Corte de pastel nupcial',                         responsible:'Coordinadora MR',   startTime:'22:50', endTime:'23:05', status:'PENDING',   notes:'6 pisos, fondant ivory. Fotografía y video en posición.' },
    { id:'act-509', phaseId:'ph-5', name:'Postre, petit fours y café de altura',            responsible:'Catering Aurora',   startTime:'23:05', endTime:'23:30', status:'PENDING' },
    ...
    { id:'act-604', phaseId:'ph-6', name:'DJ Set principal — música internacional y latina', responsible:'DJ Neon',           startTime:'00:15', endTime:'02:00', status:'PENDING' },
    { id:'act-605', phaseId:'ph-6', name:'Show sorpresa: fuegos artificiales en jardín',    responsible:'Pirotecnia Élite',  startTime:'01:00', endTime:'01:15', status:'PENDING',   notes:'5 min de show. Coordinación con Venue para área designada.' },
...
const tareas = {
  ...
  tasks: [
    ...
    { id:'t-03', code:'T-103', title:'Listar dietas especiales y restricciones de invitados',          category:'Logística',   dueDate:'2026-06-14', assignee:'MR', status:'POR_HACER', notes:'Revisar RSVPs — 18 celíacos, 7 vegetarianos confirmados' },
    ...
    { id:'t-09', code:'T-203', title:'Pago anticipo 40% — Flores del Valle',                          category:'Pagos',       dueDate:'2026-05-29', assignee:'MR', status:'EN_CURSO',  notes:'Monto: $48,000 MXN. Transferencia pendiente aprobación dirección.' },
    ...
    { id:'t-11', code:'T-205', title:'Revisión y aprobación de maqueta de pastel nupcial',            category:'Catering',    dueDate:'2026-05-25', assignee:'PL', status:'EN_CURSO',  notes:'Reunión con repostera el 24-may. Novia debe confirmar diseño.' },

    // ESPERANDO OK
    { id:'t-12', code:'T-301', title:'Revisar propuesta de seating chart (v2) con familia García',    category:'Cliente',     dueDate:'2026-05-23', assignee:'AF', status:'ESPERANDO_OK', notes:'Mesa de honor: disposición en U. Familia López pidió cambios.' },
    ...
    // LISTA (completadas o listas)
    { id:'t-16', code:'T-401', title:'Firmar contrato y póliza con venue principal',                  category:'Legal',       dueDate:'2026-04-29', assignee:'MR', status:'LISTA',       notes:'Firmado con depósito del 50%. Cláusula de cancelación 60 días.' },
    { id:'t-17', code:'T-402', title:'Confirmación y reserva de fotógrafo Focus Studio',             category:'Foto',        dueDate:'2026-05-04', assignee:'PL', status:'LISTA',       notes:'Paquete completo: foto + video + drone. Anticipo liquidado.' },
    { id:'t-18', code:'T-403', title:'Bloqueo de 20 habitaciones para invitados foráneos',           category:'Logística',   dueDate:'2026-05-09', assignee:'JC', status:'LISTA',       notes:'Hotel Presidente Intercontinental. Tarifa especial negociada.' },
    ...
    { id:'t-20', code:'T-405', title:'Envío y confirmación de invitaciones digitales (480 invitados)',category:'Coordinación',dueDate:'2026-04-30', assignee:'MR', status:'LISTA',       notes:'94% tasa de apertura. 412 confirmados, 68 pendientes de RSVP.' },
  ],
};

// ─────────────────────────────────────────────────────────────
// PRESUPUESTO (capítulos)
// ─────────────────────────────────────────────────────────────
const presupuesto = {
  updatedAt: new Date().toISOString(),
  chapters: [
  ...
  items: [
    ...
    { id:'i-205', chapterId:'ch-2', code:'C2-5', concept:'Personal de servicio (meseros y capitanes)',   provider:'Catering Aurora',  quantity:80,  unit:'pza',     unitPrice:1200,  status:'CONFIRMED' },
    ...
    { id:'i-403', chapterId:'ch-4', code:'C4-3', concept:'Show pirotécnico (jardín, 5 min)',             provider:'Pirotecnia Élite', quantity:1,   unit:'evento',  unitPrice:22000, status:'PENDING' },
    ...
    { id:'i-602', chapterId:'ch-6', code:'C6-2', concept:'62 mesas redondas 1.8m',                       provider:'Mobiliario Plus',  quantity:62,  unit:'pza',     unitPrice:450,   status:'CONFIRMED' },
    ...
    { id:'i-604', chapterId:'ch-6', code:'C6-4', concept:'Pantalla LED 9x5m + video mapping',           provider:'AV Express',       quantity:1,   unit:'evento',  unitPrice:45000, status:'PENDING' },
    ...
    { id:'i-702', chapterId:'ch-7', code:'C7-2', concept:'Traslados VIP en Sprinter (6 unidades)',      provider:'Transport Premium', quantity:6,  unit:'pza',     unitPrice:4500,  status:'PENDING' },
    ...
    { id:'i-802', chapterId:'ch-8', code:'C8-2', concept:'Menús, programas y señalética de evento',     provider:'Imprenta Élite',   quantity:500, unit:'pza',     unitPrice:45,    status:'CONFIRMED' },
...
console.log('✅ Seed Boda García López cargado en localStorage.');
console.log(`   Timeline:    ${timeline.phases.length} fases, ${timeline.activities.length} actividades`);
console.log(`   Tareas:      ${tareas.tasks.length} tareas`);
console.log(`   Presupuesto: ${presupuesto.chapters.length} capítulos, ${presupuesto.items.length} items`);
