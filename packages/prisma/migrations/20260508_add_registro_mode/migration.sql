...
-- Add payment_method and ticket_access_code_id to ticket_orders
...
-- AddForeignKey ticket_attendees -> ticket_order_items
...
-- AddForeignKey ticket_access_codes -> ticket_events
